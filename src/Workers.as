...
package 
{
	...
	public class Workers
	{
		...
		[Embed(source="../workerswfs/ci/dv/model/DiskAnalyser.swf", mimeType="application/octet-stream")]
		private static var ci_dv_model_DiskAnalyser_ByteClass:Class;
		public static function get ci_dv_model_DiskAnalyser():ByteArray
		{
			return new ci_dv_model_DiskAnalyser_ByteClass();
		}
